import pandas as pd
import numpy as np
from TP3paske.RungeKutta import runge_kutta
...
def make_csvs(initial, time_step, n):
    ...
    for i in range(1, n + 1):
        ...
        ti += time_step
        frame_i.to_csv('csv/temperature{}.csv'.format(i), header=False, index=False)

if __name__ == '__main__':
    data = pd.read_csv('csv/temperature0.csv', header=None)
    make_csvs(data, 5, 10)